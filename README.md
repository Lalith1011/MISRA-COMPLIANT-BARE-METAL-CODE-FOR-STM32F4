This project features MISRA Compliant Bare-metal code for the STM32F401. It currently consists of the drivers for the GPIO and UART peripherals. Take a look at the points below to get an overview about the usage of the drivers. 
